...
if __name__ == '__main__':
    ...
    log_path = os.path.join("Modelos", "PPO", "PPO-01")
    ...
    checkpoint_callback = CheckpointCallback(save_freq=10000, save_path='./Modelos/PPO/PPO-01',
                                         name_prefix='model')
    ...
    model_path = os.path.join("Modelos", "PPO", "PPO-01")
